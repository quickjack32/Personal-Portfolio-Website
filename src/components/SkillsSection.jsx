...
const skills = [
  ...
  { name: "R", level: 60, category: "data science" },
    ...
    // Platforms
  { name: "AWS", level: 70, category: "platforms" },
  { name: "Microsoft Azure", level: 70, category: "platforms" },
  { name: "Dataiku", level: 80, category: "platforms" },
...
const categories = ['all', 'data science', 'platforms', 'frontend', 'backend', 'tools'];
