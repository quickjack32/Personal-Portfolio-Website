...
export const NavBar = () => {
    ...
    <nav className = {cn('fixed w-full z-40 transition-all duration-300',
        ...
        {/* mobile nav overlay - static, covers the whole page when open */}
        {isMenuOpen && (
            <div className="absolute left-0 top-0 w-full h-screen bg-background/95 backdrop-blur-md z-50 flex flex-col items-center justify-center transition-all duration-300 md:hidden">
